...
% \begin{table*}
% \caption{Taxonomy and citations of graph analytics techniques}
...
\textbf{Connectivity Analysis} algorithms are used for checking the strength between nodes and sub graphs in a graph. Kosaraju's BFS and DFS are two algorithms surveyed for connectivity analysis.
