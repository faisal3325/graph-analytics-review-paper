...
The time complexity of this algorithm O($v^3$) where $v$ is number of vertices in graph. This measure is being used in telecommunication networks for measuring speed of the network and also in extracting important words from a document.

\subsubsection{Betweenness Centrality}

The time complexity of this algorithm O($v*e$) where $v$ is number of vertices and $e$ is edges in the graph.
